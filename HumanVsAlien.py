...
def draw():
    if gamestate == 0 :
        ...
        screen.draw.text("Human Vs Alien", midtop=(400, 50), owidth=0.01,
                        ocolor=(0, 0, 0), color=(255, 255, 255), fontsize=100)
        screen.draw.text("Press RETURN to start", midtop=(400, 400), owidth=0.01,
                        ocolor=(0, 0, 0), color=(255, 255, 255), fontsize=100)
    if gamestate == 1 :
        if Point != 0 :
            screen.blit('background', (0,0))
            ...
            screen.draw.text("Pass A ", midtop=(700, 42), owidth=0.01,
                                ocolor=(0, 0, 0), color=(255, 255, 255), fontsize=18)
            screen.draw.text("Pass S ", midtop=(700, 90), owidth=0.01,
                                ocolor=(0, 0, 0), color=(255, 255, 255), fontsize=18)
        if Point == 0 :
            screen.fill((0,0,0))
            screen.draw.text("Game Over", midtop=(400, 300), owidth=0.01,
                                ocolor=(0, 0, 0), color=(255, 255, 255), fontsize=120)
            screen.draw.text("Human Winnnn!!!a", midtop=(400, 100), owidth=0.01,
                                ocolor=(0, 0, 0), color=(255, 255, 255), fontsize=100)
            screen.draw.text("Press RETURN", midtop=(400, 500), owidth=0.01,
                                ocolor=(0, 0, 0), color=(255, 255, 255), fontsize=100)
        if Human.lives == 0 :
            screen.fill((0,0,0))
            screen.draw.text("Game Over", midtop=(400, 300), owidth=0.01,
                                ocolor=(0, 0, 0), color=(255, 255, 255), fontsize=120)
            screen.draw.text("Alien Winnnn!!!", midtop=(400, 100), owidth=0.01,
                                ocolor=(0, 0, 0), color=(255, 255, 255), fontsize=100)
            screen.draw.text("Press RETURN ", midtop=(400, 500 ), owidth=0.01,
                                ocolor=(0, 0, 0), color=(255, 255, 255), fontsize=100)

def update():
    global Human,moveCounter,lasers,state,Point,PutDelay,HumanHit,gamestate
    if Point == 0 :
        gamestate = 2
    if Human.lives == 0 :
        gamestate = 2
    if Point != 0 :
        ...
        if keyboard.down:
            if Human.y < 570:
                Human.y += 5
        if keyboard[keys.A] and Point > 0 and PutDelay > 10 :
            state = 0
            Point -= 2
            drawAliens()
            updateAliens()
            ...
            if moveCounter == moveDelay:
                moveCounter = 0
        if keyboard[keys.S] and Point > 0 and PutDelay > 20:
            state = 1
            Point -= 5
            drawAliens()
            updateAliens()
